                    ...
                    <div class="body">
                        <div class="table-responsive">                            
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    @foreach ($pesawat as $d)
                                        <tr>
                                            <td>{{$d->maskapai}}</td>
                                            <td>{{$d->jenis_kelas_pesawat}}</td>
                                            <td>{{$d->keberangkatan_pesawat}}</td>
                                            <td>{{$d->kedatangan_pesawat}}</td>
                                            <td>{{$d->asal_pesawat}}</td>
                                            <td>{{$d->tujuan_pesawat}}</td>                                            
                                            <td>{{$d->jumlah_seat}}</td>
                                            <td><a href="editPlaneDataTransportation/{{$d->id_pesawat}}" class="btn btn-primary glyphicon glyphicon-edit"></a><a href="deletePlaneDataTransportation/{{$d->id_pesawat}}" class="btn btn-danger glyphicon glyphicon-trash"></a></td>
                                        </tr>                                        
                                    @endforeach
                                </tbody>
                            </table>
                            <a href="{{route('adminPlaneInputTransportation')}}" class="btn btn-block btn-lg btn-success waves-effect">Tambah</a>
                        </div>
                    </div>
                </div>
            </div>
