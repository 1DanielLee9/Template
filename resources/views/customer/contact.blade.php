...
-->
    	<title>Chiketto | Contact Page</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="page-direction-button">
                        <a href="{{route('customerHome')}}"><i class="fa fa-home"></i>Go Back Home</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact-us">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="{{asset('customer/img/contact-01.jpg')}}" alt="">
                </div>
                <div class="col-md-6">
                    <img src="{{asset('customer/img/contact-02.jpg')}}" alt="">
                </div>
                <div class="col-md-4">
    ...
    <section class="map">
        ...
        -->
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7187.655147058993!2d110.308695!3d-7.019476!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x361babd08bddbf38!2sSMK%20Bagimu%20Negeriku!5e1!3m2!1sen!2sth!4v1578388440054!5m2!1sen!2sth" width="100%" height="500" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
        </div>
